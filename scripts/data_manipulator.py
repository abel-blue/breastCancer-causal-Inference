...
class DataCleaner:
    ...
    def remove_unwanted_columns(self, columns: list) -> pd.DataFrame:
        ...
        self.logger.info(f"Successfully removed columns {columns}")
        return self.df
    ...
    def remove_nulls(self) -> pd.DataFrame:
        self.logger.info(f"Successfully removed null values")
    ...
    def remove_single_value_columns(self, unique_value_counts: pd.DataFrame) -> pd.DataFrame:
        ...
        self.logger.info(f"Successfully removed columns {drop_cols}")
    ...
    def remove_duplicates(self) -> pd.DataFrame:
        ...
        self.logger.info(f"Successfully removed duplicates")
